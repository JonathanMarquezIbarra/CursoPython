...
objeto = op_basicas()
# Con la sentencia isinstance se verifica si existe herencia_
#_entre clases, y devuelve true o false
print(isinstance(objeto,raiz))
# Con issubclass se verifica si la primer clase hereda arumentos del_
#_la segunda clase
